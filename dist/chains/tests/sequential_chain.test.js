...
test("Test SequentialChain input/output chains' validation", () => {
    ...
    }).toThrowErrorMatchingInlineSnapshot(`"Missing variables for chain "llm_chain": "input2". Only got the following variables: "input1"."`);
    expect(() => {
        /* eslint-disable no-new */
        new SequentialChain({
            chains: [chain1, chain2],
...
test("Test SequentialChain chains' intermediate variables validation", () => {
    ...
    }).toThrowErrorMatchingInlineSnapshot(`"Missing variables for chain "llm_chain": "input3". Only got the following variables: "input1", "input2", "nonexistent"."`);
});
